    ...
    <div class="row align-items-center">
      <div class="col-lg-12">
        <div class="about3-textarea">
          ...
          <p>
            Report and state your claims: enquiries@certariassetmangement.com
          </p>

          <div class="about3-pera-text">
              <p class="mt-1"> <b>For Enquiries </b></br>
Misconducts can be disclosed via any of the following channels. Report and state your claims enquiries@certariassetmangement.com
              </br></br>
